...
insert_type = ['all'] 
insert_csv_data_to_mongo(temporal_landing_path, collection_name, data_base_mongo, insert_type)
...
insert_type = ['all']
insert_json_data_mongo(temporal_landing_path, collection_name, data_base_mongo, insert_type)